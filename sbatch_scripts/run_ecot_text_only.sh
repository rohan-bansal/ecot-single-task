...
#SBATCH --output=/srv/rl2-lab/flash7/zhenyang/ecot-single-task/runs/logs/train_ecot_text_only.out
#SBATCH --error=/srv/rl2-lab/flash7/zhenyang/ecot-single-task/runs/logs/train_ecot_text_only.err
